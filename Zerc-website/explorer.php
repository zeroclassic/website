...
if( empty($_GET) ) { ?>
    ...
    <section class="block-explorer-features section bg-bottom pb-0">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
    ...
    <section class="block-explorer-section section bg-bottom pt-0">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="center-heading">
                ...
                <div class="col-lg-12">
                    <div class="center-heading">
                        <div class="btn-group d-flex" role="group" aria-label="Basic example">
                            <button type="button" id="networkHashrate" class="btn btn-dark w-100 active">Network Hashrate</button>
                            <button type="button" id="coinValue" class="btn btn-dark w-100">Price History</button>
                            <button type="button" id="blockDifficulty" class="btn btn-dark w-100">Block Difficulty</button>
